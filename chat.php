...
<div class="bg chat">
    ...
    <div class="container-small">
        <div class="sidebar sidebar-bigger">
            
            <div class="dialog-person">
                <div class="chat-box">
                    <ul>
                        <li class="active">
                            <img class="chat-image fl" src="img/paragraph.jpg">
                            <div class="chat-info">
                                <p class="chat-name">Tony Good</p>
                                <p class="chat-age ls3">40 YRS</p>
                        ...
                        <li>
                            <img class="chat-image fl" src="img/paragraph.jpg">
                            <div class="chat-info">
                                <p class="chat-name">Angelina Jolie</p>
                                <p class="chat-age ls3">25 YRS</p>
                                <p class="new-message">1 unread message</p>
        ...
        <div class="content content-chat">
            <div class="chat-header">
                <img class="chat-image fl" src="img/paragraph.jpg">
                <div class="chat-info">
                    <h2>Chat with <span>Angelina Jolie</span></h2>
                    <p class="chat-status">offline</p>
            ...
            <div class="chat-message">
                <form>
                    ...
                    <button class="pinkBtn" type="button"><i class="fa fa-envelope-o" aria-hidden="true"></i> Send Message</button>
                </form>
            </div>
        </div>
    </div>
